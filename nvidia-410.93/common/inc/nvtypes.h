...
#ifdef NV_MISRA_COMPLIANCE_REQUIRED
/*
 * Other names used in ucode
 * Should remove these once all types are changed to Nv types
 */
typedef NvU32   uint;
typedef NvU8   uchar;
typedef NvU16 ushort;
typedef NvU8    Bool;
typedef NvU32   UInt;
typedef NvS32    Int;
typedef NvF32  Float;
typedef NvF64 Double;
typedef NvS8    Char;
typedef NvU8    Byte;
#endif
