...
#define BIT_IDX_32(n)                   \
   ((((n) & 0xFFFF0000U)? 0x10: 0) |     \
    (((n) & 0xFF00FF00U)? 0x08: 0) |     \
    (((n) & 0xF0F0F0F0U)? 0x04: 0) |     \
    (((n) & 0xCCCCCCCCU)? 0x02: 0) |     \
    (((n) & 0xAAAAAAAAU)? 0x01: 0) )
...
{                                       \
    NvU32 idx = 0;                      \
    if ((n32) & 0xFFFF0000U) idx += 16;  \
    if ((n32) & 0xFF00FF00U) idx += 8;   \
    if ((n32) & 0xF0F0F0F0U) idx += 4;   \
    if ((n32) & 0xCCCCCCCCU) idx += 2;   \
    if ((n32) & 0xAAAAAAAAU) idx += 1;   \
    (n32) = idx;                        \
}
