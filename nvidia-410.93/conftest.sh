...
compile_test() {
    case "$1" in
        ...
        dev_pm_ops)
            #
            # Determine if the 'dev_pm_ops' data type is present
            #
            echo "$CONFTEST_PREAMBLE
            ...
            if [ -f conftest$$.o ]; then
                echo "#define NV_DEV_PM_OPS_PRESENT" | append_conftest "types"
                rm -f conftest$$.o
                return
            else
                echo "#undef NV_DEV_PM_OPS_PRESENT" | append_conftest "types"
                return
            fi
        ;;
      ...
      pci_dma_mapping_error)
        ...
        vfio_device_gfx_plane_info)
            ...
            #
            # Added: 2017-11-23 e20eaa2382e7888a4e06ccb015c476a6fb1fda0c
            #
            CODE="
            #include <linux/vfio.h>
        ...
        of_get_ibm_chip_id)
            ...
            #
            # of_get_ibm_chip_id symbol export was introduced in 4.2
            #   2015-05-07  b130e7c04f1130f241eddf72098a6e08d41d08fe
            #
            CODE="
            #include <linux/version.h>
        ...
        dma_buf_owner)
            ...
            #
            # The owner field was added by:
            #   2015-05-05  9abdffe286c1532a54d5aee31571d3029be4026c
            #
            CODE="
        ...
        node_states_n_memory)
            ...
            #
            # This constant was added by:
            #   2012-12-12  8219fc48adb3b09eabf502c560bf13f273ea69a3
            CODE="
